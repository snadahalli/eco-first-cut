...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '3692f1a0-0177-4607-ac68-fd885046fc55' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('d5f276e8-8170-4de6-8ed8-4703010a6c91');
      cy.get(`[data-cy="name"]`).should('have.value', 'd5f276e8-8170-4de6-8ed8-4703010a6c91');
